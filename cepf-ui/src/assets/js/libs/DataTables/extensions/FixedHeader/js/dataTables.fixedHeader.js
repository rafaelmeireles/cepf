...
/*
 * Variable: afnScroll
 * Purpose:  Array of functions that are to be used for the scrolling component
 * Scope:    FixedHeader
 */
...
/*
 * Just one 'scroll' event handler in FixedHeader, which calls the required component. This is
